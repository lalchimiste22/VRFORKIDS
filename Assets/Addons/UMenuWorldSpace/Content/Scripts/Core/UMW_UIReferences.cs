...
public class UMW_UIReferences : MonoBehaviour
{
    ...
    private Button playButtonScript;
    ...
    void Awake()
    {
        ...
        if(Manager.Levels.Count > 0) { SetSelectLevel(Manager.Levels[0]); }
    }
    ...
    /// 
    /// </summary>
    public void SetSelectLevel(UMW_LevelInfo info)
    {
        cacheLevelInfo = info;
        ...
        playButtonScript.interactable = !info.Locked;
        playButtonScript.GetComponentInChildren<Text>().text = info.Locked ? "Locked" : "Play";
    }
