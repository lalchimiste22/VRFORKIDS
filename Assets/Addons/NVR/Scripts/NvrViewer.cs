...
public class NvrViewer : MonoBehaviour {
     // base 2.0.4
    public const string NVR_SDK_VERSION = "2.0.4_20170209_pre";
    // dtr or not
  ...
  void OnDestroy() {
    ...
    /// <summary>
    ///  添加相机特效脚本【由于加入特效对帧率影响太大，目前不开放此接口】
    /// </summary>
    /// <typeparam name="T">脚本类型</typeparam>
    private void AddCameraEffect<T>() where T : Component
    {
